---
title: "SMARTIES T-matrices"
subtitle: "EBCM for spheroids"
author: "baptiste"
date: today
format: html
---

Below is an example script to run a SMARTIES simulation at multiple wavelenghts, and export the T-matrices in HDF5. The script is available as [smarties/test_multiple_tmatrix_hdf5.m](smarties/test_multiple_tmatrix_hdf5.m).
