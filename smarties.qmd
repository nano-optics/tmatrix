...
Output file: [smarties_spectrum.h5](smarties_spectrum.h5)

`r library(knitr);library(xfun);f=knitr::current_input();print(f)`
`r invisible(purl(with_ext(f, "qmd"),output=with_ext(f, "m")))`
