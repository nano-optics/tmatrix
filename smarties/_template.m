...
epsilon = struct('embedding', medium^2, '{material}', epsilon);
...
comments = struct('name', '{material} {shape} spheroid in water',...
    ...
    'keywords', '{material}, {shape} spheroid, ebcm', ...
    'sources', '{material} from {source}',...
    'script', [mfilename '.m']);


[f, uuid] = tmatrix_hdf5('../export/smarties_{material}_{medium}_{a}_{c}.tmat.h5', tmatrix, modes, wavelength, epsilon, geometry, computation, comments)
