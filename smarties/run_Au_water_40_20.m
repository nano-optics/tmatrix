...
comments = struct('name', 'Au oblate spheroid in water',...
    ...
    'keywords', 'Au, oblate spheroid, ebcm', ...
    'sources', 'Au from Raschke et al 10.1103/PhysRevB.86.235147',...
    'script', [mfilename '.m']);


[f, uuid] = tmatrix_hdf5('../export/smarties_Au_water_40_20.tmat.h5', tmatrix, modes, wavelength, epsilon, geometry, computation, comments)