...
comments = struct('name', 'Ag oblate spheroid in water',...
    ...
    'keywords', 'Ag, oblate spheroid, ebcm', ...
    'sources', 'Ag from Raschke et al 10.1103/PhysRevB.91.235137',...
    'script', [mfilename '.m']);


[f, uuid] = tmatrix_hdf5('../export/smarties_Ag_water_50_40.tmat.h5', tmatrix, modes, wavelength, epsilon, geometry, computation, comments)