...
epsilon = struct('embedding', medium^2, 'Ag', epsilon);
...
comments = struct('name', 'Ag prolate spheroid in water',...
    ...
    'keywords', 'Ag, prolate spheroid, ebcm', ...
    'sources', 'Ag from Raschke et al 10.1103/PhysRevB.91.235137',...
    'script', [mfilename '.m']);


[f, uuid] = tmatrix_hdf5('../export/smarties_Ag_water_30_40.tmat.h5', tmatrix, modes, wavelength, epsilon, geometry, computation, comments)